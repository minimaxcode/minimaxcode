    ...
    <div className="min-h-screen text-gray-900 pt-24" style={{ background: 'linear-gradient(180deg, #F6FAFF 0%, #FFFFFF 100%)' }}>
      ...
      <section className="relative bg-transparent pt-[var(--header-h)] md:pt-0 md:-mt-[var(--header-h)]">
        <div className="relative w-full h-auto aspect-[16/9] md:aspect-[5/2] lg:aspect-[21/9]">
          ...
          >
            <img src="/images/education-hero.jpg" alt="Education Hero" className="w-full h-full object-contain md:object-cover object-center" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#2F4766]">{t('education.needs.title')}</h2>
      ...
      <section className="py-12 md:py-20 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#2F4766]">{t('education.solutions.title')}</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
