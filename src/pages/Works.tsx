              ...
              >
                ...
                >
                  ...
                  <div className="lg:w-1/2 w-full min-w-0">
                    <h3 className="text-3xl font-bold text-[#2F4766] mb-4 break-words">{t(project.titleKey)}</h3>
                    ...
                    <div className="mt-auto flex">
                      <a href={project.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-[#0EA5FF] hover:bg-[#0284C7] text-white font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md group">
                        {t('works.visitSite')}
